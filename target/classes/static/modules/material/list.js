layui.use(['form','layer','laydate','myTable','laytpl','formSelects','upload'],function(){
    ...
    var tableColumns = [
	        ...
	        {field: 'name', title: '器材名称', align:"center",width:100,sort:true},
	        {field: 'status', title: '状态', align:"center",width:100, sort:true},
	        {field: 'createdate', title: '录入日期', align:"center",width:100, sort:true,templet:function(d){
				if(!d.createdate)
					return '-';
				return layui.util.toDateString(d.createdate, 'yyyy-MM-dd');
			}},
	        {field: 'info', title: '器材介绍', align:"center", sort:true},
 ...
 function showBook(id){
	topWin(window).tabAdd({
		title:'预约记录',
		url:`${SYS_CFG.ctxPath}/book/list?type=material&materialid=`+id,
